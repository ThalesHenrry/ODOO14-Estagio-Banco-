...
class Banco(models.Model):
    ...
    pag_cheque = fields.Boolean(string="Pagamento com Cheque?")
    cheques = fields.Many2one('cheque')
    valor_cheque = fields.Monetary(related='cheques.valor', string="Valor do cheque")

    def butao(self):
        if self.pag_cheque==True:
            vals_list = {'name': '/',
